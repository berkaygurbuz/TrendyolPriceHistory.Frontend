<template>
        <div class="middle-section text-center">
                ...
                <p>It's great to find cheap products!</p>
                <h2>Find a discount product today</h2>
...
.my-btn {
    ...
    width: 15%;
    font-weight: 600;
    background-color: #25178f !important;
    ...
    .my-btn:hover {
        background-color: #140B5C !important;
    }
